...
wget -T 20 -O /tmp/panel.zip https://mirror.ghproxy.com/https://raw.githubusercontent.com/wlc743859910/BaoTa_Linux_Panel/master/LinuxPanel-7.7.0/LinuxPanel-7.7.0.zip
